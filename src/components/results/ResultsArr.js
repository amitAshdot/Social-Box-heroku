...
const ResultsArr = () => {
    ...
    const finaleRender = filtered.map((item, index) => {
        ...
        return (
            <div className='result-referral' key={index}>
    ...
    return (
        <div className='result'>
            <AliceCarousel
                mouseTracking items={[...finaleRender]} responsive={responsive}
                controlsStrategy="alternate" autoWidth disableButtonsControls onResized
                disableDotsControls
